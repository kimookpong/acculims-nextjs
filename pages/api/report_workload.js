...
export default function handler(req, res) {
  ...
  let cond = ``;
  if(date_start != undefined && date_stop != undefined){cond = cond + `WHERE t1.order_date BETWEEN '${date_start}' AND '${date_stop}' 
  ...
  const query = `SELECT t1.order_date, t1.order_time, t1.hn, t3.pname, t3.fname, t3.lname, t3.birthday, t1.department,
  t1.receive_time, t1.approved_time, t1.form_name, t2.lab_items_name_ref, t2.lab_order_result,
