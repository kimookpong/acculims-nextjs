...
const covidTest = [
  ...
  "Covid 19 Ag (Biorad)",
  "Covid 19 Ag (Bio on step)",
];
const individualAnotherTest = [
  "AFP",
  "CEA",
  "Total PSA",
  "Anti HIV",
...
const Page = () => {
  ...
  const [indeterminate_lipidProfile, setIndeterminate_lipidProfile] =
    useState(true);
  ...
  const onChange_lipidProfile = (list) => {
    ...
    setIndeterminate_lipidProfile(
      !!list.length && list.length < lipidProfile.length
    );
  ...
  //liverFunctionTest
  const [checkedList_liverFunctionTest, setCheckedList_liverFunctionTest] =
    useState();
  const [indeterminate_liverFunctionTest, setIndeterminate_liverFunctionTest] =
    useState(true);
  const [checkAll_liverFunctionTest, setCheckAll_liverFunctionTest] =
    useState(false);
  const onChange_liverFunctionTest = (list) => {
    setCheckedList_liverFunctionTest(list);
    setIndeterminate_liverFunctionTest(
      !!list.length && list.length < liverFunctionTest.length
    );
  ...
  const [indeterminate_electrolyte, setIndeterminate_electrolyte] =
    useState(true);
  ...
  const onChange_electrolyte = (list) => {
    ...
    setIndeterminate_electrolyte(
      !!list.length && list.length < electrolyte.length
    );
  ...
  //renalFunctionTest
  const [checkedList_renalFunctionTest, setCheckedList_renalFunctionTest] =
    useState();
  const [indeterminate_renalFunctionTest, setIndeterminate_renalFunctionTest] =
    useState(true);
  const [checkAll_renalFunctionTest, setCheckAll_renalFunctionTest] =
    useState(false);
  const onChange_renalFunctionTest = (list) => {
    setCheckedList_renalFunctionTest(list);
    setIndeterminate_renalFunctionTest(
      !!list.length && list.length < renalFunctionTest.length
    );
  ...
  const [indeterminate_hematology, setIndeterminate_hematology] =
    useState(true);
  ...
  const onChange_hematology = (list) => {
    ...
    setIndeterminate_hematology(
      !!list.length && list.length < hematology.length
    );
  ...
  const [indeterminate_urinalysis, setIndeterminate_urinalysis] =
    useState(true);
  ...
  const onChange_urinalysis = (list) => {
    ...
    setIndeterminate_urinalysis(
      !!list.length && list.length < urinalysis.length
    );
  ...
  //tyroidFunction
  const [checkedList_tyroidFunction, setCheckedList_tyroidFunction] =
    useState();
  const [indeterminate_tyroidFunction, setIndeterminate_tyroidFunction] =
    useState(true);
  ...
  const onChange_tyroidFunction = (list) => {
    ...
    setIndeterminate_tyroidFunction(
      !!list.length && list.length < tyroidFunction.length
    );
  ...
  return (
    <>
      ...
      <br></br>
      <Checkbox
        indeterminate={indeterminate_lipidProfile}
        onChange={onCheckAllChange_lipidProfile}
        checked={checkAll_lipidProfile}
      >
        <h3>Lipid Profile:</h3>
      </Checkbox>
      <CheckboxGroup
        options={lipidProfile}
        value={checkedList_lipidProfile}
        onChange={onChange_lipidProfile}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_liverFunctionTest}
        onChange={onCheckAllChange_liverFunctionTest}
        checked={checkAll_liverFunctionTest}
      >
        <h3>Liver Function Test:</h3>
      </Checkbox>
      <CheckboxGroup
        options={liverFunctionTest}
        value={checkedList_liverFunctionTest}
        onChange={onChange_liverFunctionTest}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_electrolyte}
        onChange={onCheckAllChange_electrolyte}
        checked={checkAll_electrolyte}
      >
        <h3>Electrolyte:</h3>
      </Checkbox>
      <CheckboxGroup
        options={electrolyte}
        value={checkedList_electrolyte}
        onChange={onChange_electrolyte}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_renalFunctionTest}
        onChange={onCheckAllChange_renalFunctionTest}
        checked={checkAll_renalFunctionTest}
      >
        <h3>Renal Function Test:</h3>
      </Checkbox>
      <CheckboxGroup
        options={renalFunctionTest}
        value={checkedList_renalFunctionTest}
        onChange={onChange_renalFunctionTest}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_hematology}
        onChange={onCheckAllChange_hematology}
        checked={checkAll_hematology}
      >
        <h3>Hematology:</h3>
      </Checkbox>
      <CheckboxGroup
        options={hematology}
        value={checkedList_hematology}
        onChange={onChange_hematology}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_urinalysis}
        onChange={onCheckAllChange_urinalysis}
        checked={checkAll_urinalysis}
      >
        <h3>Urinalysis:</h3>
      </Checkbox>
      <CheckboxGroup
        options={urinalysis}
        value={checkedList_urinalysis}
        onChange={onChange_urinalysis}
      />
      <br></br>
      <CheckboxGroup options={individualUrinetest} onChange={onChange} />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_tyroidFunction}
        onChange={onCheckAllChange_tyroidFunction}
        checked={checkAll_tyroidFunction}
      >
        <h3>Thyroid Function Test:</h3>
      </Checkbox>
      <CheckboxGroup
        options={tyroidFunction}
        value={checkedList_tyroidFunction}
        onChange={onChange_tyroidFunction}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_caTest}
        onChange={onCheckAllChange_caTest}
        checked={checkAll_caTest}
      >
        <h3>CA Test:</h3>
      </Checkbox>
      <CheckboxGroup
        options={caTest}
        value={checkedList_caTest}
        onChange={onChange_caTest}
      />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_covidTest}
        onChange={onCheckAllChange_covidTest}
        checked={checkAll_covidTest}
      >
        <h3>COVID Test:</h3>
      </Checkbox>
      <CheckboxGroup
        options={covidTest}
        value={checkedList_covidTest}
        onChange={onChange_covidTest}
      />
      <br></br>
      <CheckboxGroup options={individualAnotherTest} onChange={onChange} />
      <br></br>
      <Checkbox
        indeterminate={indeterminate_payment}
        onChange={onCheckAllChange_payment}
        checked={checkAll_payment}
      >
        <h3>payment:</h3>
      </Checkbox>
      <CheckboxGroup
        options={payment}
        value={checkedList_payment}
        onChange={onChange_payment}
      />
      <Divider></Divider>
      <p>เพศ</p>
      <input
